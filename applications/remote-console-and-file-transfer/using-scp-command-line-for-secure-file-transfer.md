...
We'll assume that you've already used the [interactive installer](../../adding-remote.it-to-your-device/using-the-interactive-installer/) or [bulk registration](../../mass-production/bulk-registration.md) to configure a remote.it Service for SSH on your target device.
